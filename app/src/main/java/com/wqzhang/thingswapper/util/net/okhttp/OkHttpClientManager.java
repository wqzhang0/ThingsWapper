...
//        mOkHttpClient.setCookieHandler(new CookieManager(null, CookiePolicy.ACCEPT_ORIGINAL_SERVER));
    ...
    public OkHttpClient getCookieClient() {
        ClearableCookieJar cookieJar =
                new PersistentCookieJar(new SetCookieCache(), new SharedPrefsCookiePersistor(MainApplication.getGlobleContext()));


        OkHttpClient mHttpClient = new OkHttpClient.Builder().cookieJar(cookieJar).build();
        return mHttpClient;
    }
    //*************对外公布的方法************
...
//                new OkHttpClientManager.ResultCallback<UserDTO>() {
//
//                    @Override
