...
public class ChartsRecyclerAdapter extends RecyclerView.Adapter {
    ...
    private ArrayList<ChartDataDTO> toDayResultData;
    private ArrayList<ChartDataDTO> weekNewThings;
    private ArrayList<ChartDataDTO> weekFinshThings;
    ...
    public ArrayList<ChartDataDTO> getToDayResultData() {
    ...
    private class PiechartHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(ArrayList<ChartDataDTO> chartDataModelSparseArray) {
...
//                    Log.d(TAG, "onNothingSelected");
    ...
    private class LinechartHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(final ArrayList<ChartDataDTO> newThingsModels, final ArrayList<ChartDataDTO> finshThingsModels, String label1, String lable2) {
            ArrayList<Entry> newThingsList = new ArrayList<>();
            ArrayList<Entry> finshThingsList = new ArrayList<>();
            for (int i = 0; i < newThingsModels.size(); i++) {
//                values.add(new Entry(DateUtil.getWeek(chartDataModelSparseArray.get(i).getDate()), (float) chartDataModelSparseArray.get(i).getCount()));
                int weekKey = DateUtil.getWeekHasToday(newThingsModels.get(i).getDate());
                newThingsList.add(new Entry(i, (float) newThingsModels.get(i).getCount(), weekKey));
                finshThingsList.add(new Entry(i, (float) finshThingsModels.get(i).getCount(), weekKey));
            }

            LineDataSet newThingslineDataSet = new LineDataSet(newThingsList, label1);
            setDatsSetStyle(newThingslineDataSet, 1);
            LineDataSet finshThingslineDataSet = new LineDataSet(finshThingsList, lable2);
            setDatsSetStyle(finshThingslineDataSet, 2);

            ArrayList<ILineDataSet> dataSets = new ArrayList<ILineDataSet>();
            dataSets.add(newThingslineDataSet);
            dataSets.add(finshThingslineDataSet);
            setShow(dataSets);
        }


        public void setData(final ArrayList<ChartDataDTO> dataList, String label) {
            ArrayList<Entry> values = new ArrayList<>();
            for (int i = 0; i < dataList.size(); i++) {
                int weekKey = DateUtil.getWeekHasToday(dataList.get(i).getDate());
                values.add(new Entry(i, (float) dataList.get(i).getCount(), weekKey));
            }
